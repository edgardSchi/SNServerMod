...
{	
	override void Init()
	{
		...
		//ingredient 2
		InsertIngredient(1,"SN_Tripod");//you can insert multiple ingredients this way
...
modded class craftbox extends RecipeBase
{
	override void Init()
	{
		m_Name = "Craft Box";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"foldedbox");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("box_crate");//add results here
