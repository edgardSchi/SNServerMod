class fingerlesshandschuhe extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Finger abschneiden";
		...
		//ingredient 1
		InsertIngredient(0,"WorkingGloves_Black");//you can insert multiple ingredients this way
		InsertIngredient(0,"TacticalGloves_Black");//you can insert multiple ingredients this way
		InsertIngredient(0,"LeatherGloves_Black");//you can insert multiple ingredients this way
		...
		AddResult("Fingerless_Gloves");//single result
