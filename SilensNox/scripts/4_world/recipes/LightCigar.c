class LightCigar extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Zigarre anmachen";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"LOA_cigar_mung_unlit");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("LOA_cigar_mung_lit");//add results here
