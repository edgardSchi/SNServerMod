modded class PaintAK74 extends RecipeBase
{	
	override void Init()
	{
		m_Name = "#STR_paint0";
	...
	{
		PaintItem.Paint(ingredients[0], ingredients[1], "AK74", player, specialty_weight);
	}
};

modded class PaintRuger1022 extends RecipeBase
{	
	override void Init()
	{
		m_Name = "#STR_paint0";
