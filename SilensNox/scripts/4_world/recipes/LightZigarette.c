class LightZigarette extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Zigarette anmachen";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"LOA_cigarette_mung_unlit");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("LOA_cigarette_mung_lit");//add results here
