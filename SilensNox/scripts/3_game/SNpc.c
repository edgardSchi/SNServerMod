modded class PlayerConstants 
{
	...
	static const float SHOES_MOVEMENT_DAMAGE_PER_STEP = 0.0035;
	...
	//--------------------------------------------------------
	static const int BLOOD_THRESHOLD_FATAL 					= 2000;	//fatal blood level
	
	static const float BLOOD_REGEN_RATE_PER_SEC				= 0.1; 	//base amount of blood regenerated per second
	static const float DAMAGE_ZONE_BLOOD_REGEN_MODIFIER 	= 0.1;
	...
	static const float SALINE_BLOOD_REGEN_PER_SEC			= 0.5;	//boost for blood regen per second, independent on BLOOD_REGEN_SPEED
	...
	//--------------------------------------------------------
	static const float LOW_ENERGY_DAMAGE_PER_SEC			= 0.0125;	//health loss per second while low on energy
	...
	//----------------------------------------------------------
	static const float VITAMINS_LIFETIME_SECS				= 1800;
	...
	static const float GLOVES_DAMAGE_SLIDING_LADDER_PER_SEC = -1;// how much damage the gloves receive while sliding down the ladder (per sec)
