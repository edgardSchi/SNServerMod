class CrossbowRecoil: RecoilBase
{
	override void Init()
	{
		...
		vector point_3;
		vector point_4;
		point_1[0] = Math.RandomFloatInclusive(0.1,0.1); point_1[1] = 0.1; point_1[2] = 0;
		point_2[0] = Math.RandomFloatInclusive(0.1,0.1); point_2[1] = 0.1; point_2[2] = 0;
		point_3[0] = Math.RandomFloatInclusive(0.1,0.1); point_3[1] = 0.1; point_3[2] = 0;
		point_4[0] = Math.RandomFloatInclusive(0.1,0.1); point_4[1] = 0.1; point_4[2] = 0;
		...
		m_MouseOffsetRangeMin = 0;//in degrees min
		m_MouseOffsetRangeMax = 0;//in degrees max
		m_MouseOffsetDistance = 0;//how far should the mouse travel
