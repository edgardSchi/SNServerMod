...
modded class UAQuantityConsumed
{
	...
	const float EAT_SMALL = 7.5;
	const float EAT_NORMAL = 12.5;
	const float FILL_LIQUID = 100;
	const float POUR_LIQUID = 100;
	const float DRAIN_LIQUID = 100;
	const float DRINK = 26.25;
...
modded class UATimeSpent
{
	...
	const float RESTRAIN = 15;
	const float UNRESTRAIN = 40;
	const float SHAVE = 12;
	const float SKIN = 24;

	const float DRINK_POND = 5.0;
	const float DRINK_WELL = 5.5;

	const float DIG_GARDEN = 36;
	const float DIG_STASH = 20;
	const float DIG_WORMS = 12;

	const float BURY_ASHES = 6;
	const float BURY_BODY = 24;

	const float LOCK = 6;
	const float UNLOCK = 6;
	const float UNPACK = 6;
	const float WASH_HANDS = 15;
