modded class PlayerStatsPCO_v106
{
	...
	override void Init()
	{
		...
		RegisterStat(EPlayerStats_v106.ENERGY,  		new PlayerStat<float>	(0,						20000,					1000,					"Energy",			EPSstatsFlags.EMPTY) );
		RegisterStat(EPlayerStats_v106.WATER,  			new PlayerStat<float>	(0,						5000,					1000,					"Water",			EPSstatsFlags.EMPTY) );
